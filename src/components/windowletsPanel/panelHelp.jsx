...
export default function Help() {
  ...
  useEffect(() => {
    ...
    if (error) {
      ...
      // Note: This still uses jQuery autocomplete plugin as it's complex to replace
      if (window.jQuery && inputbox) {
        window.jQuery(inputbox).autocomplete({
          lookup: topics,
          lookupLimit: 10,
          ...
          formatResult: function (suggestion, currentValue) {
            ...
            return window.jQuery.Autocomplete.defaults.formatResult(s, currentValue);
          },
